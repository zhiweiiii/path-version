...
def update_environment_variable(name, value, is_system=True):
    """更新环境变量
...
def add_to_path(path, is_system=True):
    """将路径添加到PATH环境变量
...
def switch_software_version(software, version, path, is_system=True):
    """切换软件版本
