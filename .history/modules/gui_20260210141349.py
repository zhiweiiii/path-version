...
def create_gui(software_versions):
    ...
    # 内容区域标题
    content_header = ttk.Frame(content_frame, background='#ffffff', relief='raised', borderwidth=1)
    ...
    # 创建表格
    table_frame = ttk.Frame(content_frame, background='#ffffff', relief='raised', borderwidth=1)
