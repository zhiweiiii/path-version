...
def init_parameters():
    ...
    return version_paths, enabled_versions, item_key_map, software_versions, current_nav, current_category
...
def create_gui():
    ...
    # 初始化参数
    version_paths, enabled_versions, item_key_map, software_versions, current_nav, current_category = init_parameters()
    ...
    app_data.root = root
    app_data.tree = tree
    app_data.version_paths = version_paths
    app_data.enabled_versions = enabled_versions
    app_data.item_key_map = item_key_map
    app_data.software_versions = software_versions
    app_data.current_nav = current_nav
    app_data.current_category = current_category
